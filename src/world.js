import {
	// utilities
	vec2, PI, randInt, randColor, rand,
	// engine
	setCameraPos, setRandSeed, randSeeded,
	initTileCollision, TileLayer, TileLayerData, setTileCollisionData,
...
// function setupWorld(engine, entities) {

// 	const {
// 		setCameraPos, setRandSeed, randSeeded,
// 		initTileCollision, TileLayer, TileLayerData, setTileCollisionData,
// 	} = engine;
// 	const { PlayerCharacterEntity, AnimalEntity, ItemEntity, SpiritEntity } = entities;
